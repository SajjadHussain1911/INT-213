...
Value_label=Label(detail_frame1,text="Priyanshu Suman \n\n 08 \n\n K19FR \n\n order_panel, register_page, developers_page", font=("helvetica",10, "italic")).place(x=115, y=10)
...
Value_label=Label(detail_frame2,text="Ayush Raj \n\n 09 \n\n K19FR \n\n shopping_cart, start_panel, user_login_page", font=("helvetica",10, "italic")).place(x=115, y=10)
...
Value_label=Label(detail_frame3,text="Sajjad Hussain \n\n 07 \n\n K19FR \n\n admin_login_page, admin_panel, charge_update", font=("helvetica",10, "italic")).place(x=115, y=10)
